            ...
            <div class="d-flex align-items-center justify-content-between">
              ...
              <div class="d-flex align-items-center flex-equal">
                ...
                <a href="../../demo1/dist/landing.html">
                  <img alt="Logo" src="assets/media/logo/default-small.svg" class="logo-default h-25px h-lg-30px" />
                  <img alt="Logo" src="assets/media/logo/default-small-dark.svg"
              ...
              <div class="d-lg-block" id="kt_header_nav_wrapper">
                <div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true" data-kt-drawer-name="landing-menu"
                  ...
                  <div
                    ...
                    <div class="menu-item">
                      <!--begin::Menu link-->
                      <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#how-it-works" data-kt-scroll-toggle="true"
                    ...
                    <div class="menu-item">
                      <!--begin::Menu link-->
                      <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#pricing" data-kt-scroll-toggle="true"
              ...
              @if (Route::has('login'))
                <div class="flex-equal text-end ms-1">
                  @auth
                    <a href="{{ route('dashboard.index') }}" class="btn btn-success">Home</a>
                  @else
        ...
        <div class="card" style="filter: drop-shadow(0px 0px 40px rgba(68, 81, 96, 0.08))">
          ...
          <div class="card-body p-lg-20">
            ...
            <div class="text-center mb-5 mb-lg-10">
              <!--begin::Title-->
              <h3 class="fs-2hx text-dark mb-5" id="portfolio" data-kt-scroll-offset="{default: 100, lg: 250}">Our
                Projects</h3>
              <!--end::Title-->
            </div>
            <!--end::Heading-->
                    ...
                    <div class="row g-10 mb-10">
                      ...
                      <div class="col-lg-6">
                        ...
                        <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects"
                          ...
                          <div
                            class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                            style="background-image:url('assets/media/stock/600x600/img-16.jpg')"></div>
                          <!--end::Image-->
                          <!--begin::Action-->
                          <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                            <i class="ki-duotone ki-eye fs-3x text-white">
        ...
        <div class="container">
          ...
          <div class="d-flex flex-column container pt-lg-20">
            ...
            <div class="mb-13 text-center">
              ...
              <div class="text-gray-600 fw-semibold fs-5">Save thousands to millions of bucks by using single tool for
                different
            ...
            <div class="text-center" id="kt_pricing">
              ...
              <div class="nav-group landing-dark-bg d-inline-flex mb-15" data-kt-buttons="true"
                ...
                <a href="#" class="btn btn-color-gray-600 btn-active btn-active-success px-6 py-3 me-2 active"
                  ...
                  <div class="d-flex h-100 align-items-center">
                    ...
                    <div class="w-100 d-flex flex-column flex-center rounded-3 bg-body py-15 px-10">
                      ...
                      <div class="w-100 mb-10">
                        ...
                        <!--begin::Item-->
                        <div class="d-flex flex-stack mb-5">
                          <span class="fw-semibold fs-6 text-gray-800 text-start pe-3">Up to 30 Project
                            Integrations</span>
                          <i class="ki-duotone ki-check-circle fs-1 text-success">
                            <span class="path1"></span>
                            <span class="path2"></span>
                  ...
                  <div class="d-flex h-100 align-items-center">
                    ...
                    <div class="w-100 d-flex flex-column flex-center rounded-3 bg-primary py-20 px-10">
                      ...
                      <div class="w-100 mb-10">
                        <!--begin::Item-->
                        <div class="d-flex flex-stack mb-5">
                          <span class="fw-semibold fs-6 text-white opacity-75 text-start pe-3">Up to 10 Active
                            Users</span>
                        ...
                        <!--begin::Item-->
                        <div class="d-flex flex-stack mb-5">
                          <span class="fw-semibold fs-6 text-white opacity-75 text-start pe-3">Up to 30 Project
                            Integrations</span>
                          <i class="ki-duotone ki-check-circle fs-1 text-white">
                            <span class="path1"></span>
                            <span class="path2"></span>
                        ...
                        <!--begin::Item-->
                        <div class="d-flex flex-stack mb-5">
                          <span class="fw-semibold fs-6 text-white opacity-75 text-start pe-3">Keen Analytics
                            Platform</span>
                          <i class="ki-duotone ki-check-circle fs-1 text-white">
                            <span class="path1"></span>
                            <span class="path2"></span>
                        ...
                        <!--begin::Item-->
                        <div class="d-flex flex-stack mb-5">
                          <span class="fw-semibold fs-6 text-white opacity-75 text-start pe-3">Targets Timelines &
                            Files</span>
                          <i class="ki-duotone ki-check-circle fs-1 text-white">
                            <span class="path1"></span>
                            <span class="path2"></span>
      ...
      <div class="container">
          ...
          <div class="col-lg-4">
            ...
            <div class="d-flex flex-column justify-content-between h-lg-100 px-10 px-lg-0 pe-lg-10 mb-15 mb-lg-0">
              ...
              <div class="mb-7">
                ...
                <!--end::Title-->
                <!--begin::Feedback-->
                <div class="text-gray-500 fw-semibold fs-4">The most well thought out design theme I have ever used.
                  The codes are up to tandard. The css styles are very clean. In fact the cleanest and the most up to
                  standard I have ever seen.</div>
                <!--end::Feedback-->
              </div>
              <!--end::Wrapper-->
              <!--begin::Author-->
        ...
        <div class="d-flex flex-stack flex-wrap flex-md-nowrap card-rounded shadow p-8 p-lg-12 mb-n5 mb-lg-n13"
          ...
          <div class="my-2 me-5">
            ...
            <!--end::Title-->
            <!--begin::Description-->
            <div class="fs-6 fs-lg-5 text-white fw-semibold opacity-75">Join over 100,000 Professionals Community to
              Stay Ahead</div>
            <!--end::Description-->
          </div>
          <!--end::Content-->
        ...
        <div class="container">
          ...
          <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
            ...
            <div class="d-flex align-items-center order-2 order-md-1">
              <!--begin::Logo-->
              <a href="../../demo1/dist/landing.html">
                <img alt="Logo" src="assets/media/logo/default-small.svg" class="h-15px h-md-20px" />
              </a>
              <!--end::Logo image-->
              <!--begin::Logo image-->
