                ...
                <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                    <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                            ...
                            <div class="text-gray-500 text-center fw-semibold fs-6">Belum punya akun? Daftar sebagai
                                <a href="{{ route('auth.register', 'merchant') }}" class="link-primary">Merchant</a>
                                atau
                                <a href="{{ route('auth.register', 'customer') }}" class="link-primary">Customer</a>
                            </div>
                        </form>
                    </div>
                </div>
