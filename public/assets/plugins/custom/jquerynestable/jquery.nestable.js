...
(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        emptyClass: "dd-empty",
        expandBtnHTML:
            '<button class="btn btn-icon btn-active-color-primary" data-action="expand" type="button"><i class="ki-duotone ki-plus-square"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></button>',
        collapseBtnHTML:
            '<button class="btn btn-icon btn-active-color-primary" data-action="collapse" type="button"><i class="ki-duotone ki-minus-square"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></button>',
        group: 0,
        maxDepth: 5,
        threshold: 20,
    ...
    Plugin.prototype = {
        ...
        dragStop: function (e) {
            ...
            if (
                parentItem !== null &&
                !parentItem.is("." + this.options.rootClass)
            )
